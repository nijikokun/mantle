	...
	({ className, onCopy, onCopyError, style }, ref) => {
		...
		return (
			<button
				type="button"
				className={cx(
					"absolute right-3 top-3 z-10 flex h-7 w-7 items-center justify-center rounded border border-gray-300 bg-gray-50 shadow-[-1rem_0_0.75rem_-0.375rem_hsl(var(--gray-050)),1rem_0_0_-0.25rem_hsl(var(--gray-050))] hover:border-gray-400 hover:bg-gray-200 focus-visible:border-blue-600 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue",
					copied &&
						"w-auto gap-1 border-transparent bg-success pl-2 pr-1.5 text-inverted hover:border-transparent hover:bg-success-hover focus:bg-success-active focus-visible:border-green-600 focus-visible:ring-green",
					className,
				)}
				ref={ref}
				style={style}
