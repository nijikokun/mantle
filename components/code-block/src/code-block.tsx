		...
		return (
			<button
				...
				className={cx(
					...
					copied &&
						"hover:bg-success-hover w-auto gap-1 border-transparent bg-success pl-2 pr-1.5 text-inverted hover:border-transparent focus:bg-success-active focus-visible:border-green-600 focus-visible:ring-green",
					className,
				)}
				ref={ref}
				style={style}
